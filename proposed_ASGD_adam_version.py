...
class Proposed_ASGD_adam_version(optimizer.Optimizer):
    ...
    def __init__(self, learning_rate_min=0.0001, learning_rate_max=0.01, beta1=0.9, beta2=0.99, epsilon=1e-8,
    ...
    def _apply_dense(self, grad, var):
       ...
       # @tf.function
        var_update=tf.cond(tf.math.less( ( ( tf.math.count_nonzero(g_max_mean))), 2*  ((tf.math.count_nonzero(g_min_mean)))), lambda:  state_ops.assign_sub(var,
